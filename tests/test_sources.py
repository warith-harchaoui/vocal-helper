...
def test_from_wav_file_resamples_wrong_sample_rate(tmp_path: Path) -> None:
    """A non-16 kHz file is now transparently resampled (via audio-helper),
    not rejected — 100 ms @ 8 kHz -> 16 kHz -> 5 frames of 320."""
    import scipy.io.wavfile as wavfile
