...
try:
    ...
    raise ImportError(
        ...
        "Install with: pip install 'vocal-helper[cli]'"
    ) from exc
...
def _common_options(func):
    ...
    func = click.option("--join-threshold", type=float, default=None,
                        help="Cosine-distance join threshold for online diarizer (default 0.30).")(func)
    ...
    func = click.option("--language", default="auto", show_default=True,
                        help="ISO-639-1 code or 'auto' for language ID.")(func)
    func = click.option("--whisper-model", default="large-v3-turbo-q5_0", show_default=True,
                        help="pywhispercpp model tag.")(func)
    return func
...
@click.option("--no-real-time", is_flag=True, default=False,
